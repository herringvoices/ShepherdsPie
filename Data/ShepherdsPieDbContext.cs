...
public class ShepherdsPieDbContext : IdentityDbContext<IdentityUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder
            ...
            {
                new Size {Id = 1, Name = "Personal(8 in)", Price = 6.99M},
                new Size {Id = 2, Name = "Small(10 in.)", Price = 8.99M},
                new Size {Id = 3, Name = "Medium(14 in.)", Price = 14.50M},
                new Size {Id = 4, Name = "Large(18 in.)", Price = 21.00M}
            });
            ...
            {
                new Order {Id = 1, TableNumber = 2, Date = new DateTime(2024, 1, 12), TipAmount = 4, TookOrderId = 1, DeliveryDriverId = null},
                new Order {Id = 2, TableNumber = null, Date = new DateTime(2025, 2, 1), TipAmount  = 1, TookOrderId = 2, DeliveryDriverId = 1}
            });
            modelBuilder.Entity<Pizza>().HasData(new Pizza[]
            {
                new Pizza {Id = 1, SizeId = 2, CheeseId = 3, SauceId = 1, OrderId = 1},
                new Pizza {Id = 2, SizeId = 3, CheeseId = 1, SauceId = 4, OrderId = 1},
                new Pizza {Id = 3, SizeId = 1, CheeseId = 4, SauceId = 2, OrderId = 2}
            });
